...
lambda = 0.1;     % weight decay parameter       
...
[cost, grad] = vectorizedSparseAutoencoderCost(theta, visibleSize, hiddenSize, lambda, ...
...
numgrad = computeNumericalGradient( @(x) vectorizedSparseAutoencoderCost(x, visibleSize, ...
                                                  hiddenSize, lambda, ...
                                                  sparsityParam, beta, ...
                                                  patches), theta);
